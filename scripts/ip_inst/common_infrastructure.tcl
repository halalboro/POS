...
# NOTE: vio_switch_ip_12 and vio_switch_ip_16 are now defined in the POS Extended section below
# (vio_switch_ip_12 = 3 vFIU + 9 fixed ports, vio_switch_ip_16 = 7 vFIU + 9 fixed ports)

# ============================================================================
# POS Extended vIO Switch IPs (with RDMA/TCP/Bypass ports)
# New size = N + 9 (N vFIU + 2 Host + 3 RDMA + 1 TCP + 3 Bypass)
# Port layout: vFIU[0..N-1], Host_TX, Host_RX, RDMA_RX, RDMA_TX_REQ, RDMA_TX_RSP, TCP, Bypass_RX, Bypass_TX_REQ, Bypass_TX_RSP
# Supports up to 7 vFPGAs (7 + 9 = 16 ports, Xilinx axis_switch limit)
# ============================================================================

# vio_switch_ip_10: For vio_switch_1 (1 vFIU + 9 fixed ports)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name vio_switch_ip_10
set_property -dict [list CONFIG.NUM_MI {10} CONFIG.NUM_SI {10} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips vio_switch_ip_10]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M08_AXIS_HIGHTDEST {0x23FF} CONFIG.M09_AXIS_HIGHTDEST {0x27FF}] [get_ips vio_switch_ip_10]

# vio_switch_ip_11: For vio_switch_2 (2 vFIU + 9 fixed ports)
...
# vio_switch_ip_12: For vio_switch_3 (3 vFIU + 9 fixed ports)
...
# vio_switch_ip_13: For vio_switch_4 (4 vFIU + 9 fixed ports)
...
# vio_switch_ip_14: For vio_switch_5 (5 vFIU + 9 fixed ports)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name vio_switch_ip_14
set_property -dict [list CONFIG.NUM_MI {14} CONFIG.NUM_SI {14} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips vio_switch_ip_14]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M08_AXIS_HIGHTDEST {0x23FF} CONFIG.M09_AXIS_HIGHTDEST {0x27FF} \
    CONFIG.M10_AXIS_HIGHTDEST {0x2BFF} CONFIG.M11_AXIS_HIGHTDEST {0x2FFF} \
    CONFIG.M12_AXIS_HIGHTDEST {0x33FF} CONFIG.M13_AXIS_HIGHTDEST {0x37FF}] [get_ips vio_switch_ip_14]

# vio_switch_ip_15: For vio_switch_6 (6 vFIU + 9 fixed ports)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name vio_switch_ip_15
set_property -dict [list CONFIG.NUM_MI {15} CONFIG.NUM_SI {15} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips vio_switch_ip_15]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M10_AXIS_BASETDEST {0x2800} CONFIG.M11_AXIS_BASETDEST {0x2C00} \
    CONFIG.M12_AXIS_BASETDEST {0x3000} CONFIG.M13_AXIS_BASETDEST {0x3400} \
    CONFIG.M14_AXIS_BASETDEST {0x3800} \
    CONFIG.M00_AXIS_HIGHTDEST {0x3FF} CONFIG.M01_AXIS_HIGHTDEST {0x7FF} \
    CONFIG.M02_AXIS_HIGHTDEST {0xBFF} CONFIG.M03_AXIS_HIGHTDEST {0xFFF} \
    CONFIG.M04_AXIS_HIGHTDEST {0x13FF} CONFIG.M05_AXIS_HIGHTDEST {0x17FF} \
    CONFIG.M06_AXIS_HIGHTDEST {0x1BFF} CONFIG.M07_AXIS_HIGHTDEST {0x1FFF} \
    ...
    CONFIG.M14_AXIS_HIGHTDEST {0x3BFF}] [get_ips vio_switch_ip_15]

# vio_switch_ip_16: For vio_switch_7 (7 vFIU + 9 fixed ports) - Maximum supported
