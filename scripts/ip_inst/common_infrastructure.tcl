...
# 20-port switch for 10 vFPGAs (10 host + 10 dtu)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name axis_switch_ceu_20_0
set_property -dict [list CONFIG.NUM_MI {20} CONFIG.NUM_SI {20} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips axis_switch_ceu_20_0]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M18_AXIS_HIGHTDEST {0x4BFF} CONFIG.M19_AXIS_HIGHTDEST {0x4FFF}] [get_ips axis_switch_ceu_20_0]

# 24-port switch for 12 vFPGAs (12 host + 12 dtu)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name axis_switch_ceu_24_0
set_property -dict [list CONFIG.NUM_MI {24} CONFIG.NUM_SI {24} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips axis_switch_ceu_24_0]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M22_AXIS_HIGHTDEST {0x5BFF} CONFIG.M23_AXIS_HIGHTDEST {0x5FFF}] [get_ips axis_switch_ceu_24_0]

# 28-port switch for 14 vFPGAs (14 host + 14 dtu)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name axis_switch_ceu_28_0
set_property -dict [list CONFIG.NUM_MI {28} CONFIG.NUM_SI {28} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips axis_switch_ceu_28_0]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M26_AXIS_HIGHTDEST {0x6BFF} CONFIG.M27_AXIS_HIGHTDEST {0x6FFF}] [get_ips axis_switch_ceu_28_0]

# 32-port switch for 16 vFPGAs (16 host + 16 dtu)
create_ip -name axis_switch -vendor xilinx.com -library ip -version 1.1 -module_name axis_switch_ceu_32_0
set_property -dict [list CONFIG.NUM_MI {32} CONFIG.NUM_SI {32} CONFIG.HAS_TLAST {1} CONFIG.TDATA_NUM_BYTES {64} CONFIG.TDEST_WIDTH {14} CONFIG.TID_WIDTH {6} CONFIG.DECODER_REG {1}] [get_ips axis_switch_ceu_32_0]
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x000} CONFIG.M01_AXIS_BASETDEST {0x400} \
    CONFIG.M02_AXIS_BASETDEST {0x800} CONFIG.M03_AXIS_BASETDEST {0xC00} \
    CONFIG.M04_AXIS_BASETDEST {0x1000} CONFIG.M05_AXIS_BASETDEST {0x1400} \
    CONFIG.M06_AXIS_BASETDEST {0x1800} CONFIG.M07_AXIS_BASETDEST {0x1C00} \
    ...
    CONFIG.M30_AXIS_HIGHTDEST {0x7BFF} CONFIG.M31_AXIS_HIGHTDEST {0x7FFF}] [get_ips axis_switch_ceu_32_0]